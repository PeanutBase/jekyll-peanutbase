...
#     make install
#
# 4.  Start jekyll, listening on localhost:4002 (and livereload on default port 35729)
#
#     make
#
...
serve:
	bundle exec jekyll serve --incremental --livereload --livereload_port 35729 --port 4002
